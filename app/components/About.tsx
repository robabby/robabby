          ...
          <Flex direction={{ initial: "column", md: "row" }} gap={{ initial: "4", md: "8" }} align="start">
            ...
            <Box style={{ flex: 1 }}>
              ...
              <Text className="about-lead" mb="6" style={{ display: "block" }}>
                The same instinct that led me to build design systems and component libraries now drives me to build the infrastructure behind agentic engineering — governance, workflow tooling, and the systems that make AI-assisted workflows reliable at scale.
              </Text>
